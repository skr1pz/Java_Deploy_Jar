...
:reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2" /v Flags /t REG_DWORD /d 0x43 /f
:reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Internet Settings\ZoneMap\Domains\uhs.com" /v * /t REG_DWORD /d 0x2 /f
:reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Internet Settings\ZoneMap\Domains\uhs.com\*.int" /v * /t REG_DWORD /d 0x2 /f
